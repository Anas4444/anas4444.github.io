...
const experiences = [
  {
    ...
    company_name: "Xtensus",
    icon: xtensus,
    iconBg: "#ffffff",
    date: "3 July 2023 - 4 September 2023",
    points: [
      "Converting a monolithic web application to microservices architecture using JHipster and other related technologies.",
      "Creating a custom REST API based on the conceptual part of the application.",
      "Collaborating with cross-functional teams including a Frontend Developper, 2 Backend Developpers to create high-quality products.",
